    ...
    <div id="viewport">
        <div id="page" itemscope itemtype="http://data-vocabulary.org/Person">
            ...
            <div class="centre">
                ...
                <div class="content_box" id="university">
                    <h3>University</h3>
                ...
                <div class="content_box" id="lastfm">
                    <!-- <h3>What I'm Listening To</h3> -->
                </div>

                <hr>

                <div class="content_box" id="languages">
                    <h3>Languages</h3>
                    <table>
                        <tr>
                            <td>HTML5 &amp; CSS3</td>
                ...
                <div class="content_box" id="software">
                    <h3>Software</h3>
                    <table>
                        <tr>
